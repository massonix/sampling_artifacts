...
# Load R objects
ma_plot <- readRDS("current/6-Reviews/results/R_objects/ma_plot_all_cell_types_cll.rds")
...
lollipop_go_cll <- readRDS("current/2-CLL/results/R_objects/ggplots/lollipop_go_enrichment_cll.rds")
...
ggsave(
  plot = supp6, 
  filename = "current/doc/figures/R/supp_figure6.pdf", 
  width = 18.5,
  height = 16, 
  units = "cm"
)
