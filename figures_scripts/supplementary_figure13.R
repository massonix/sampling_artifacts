...
# Arrange
supp13 <- plot_grid(row_pbmc, NULL, row_cll, NULL, row_t_act, nrow = 5, ncol = 1, rel_heights = c(1, 0.1, 1, 0.1, 1))

# Save
ggsave(supp13, filename = "current/doc/figures/R/supp13.pdf", height = 27, width = 18, units = "cm")
