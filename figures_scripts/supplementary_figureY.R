#################################################################################
##Supplementary Figure: Cell type-specific DEA ##################################
#################################################################################
...
suppY <- plot_grid(NULL, heatmap[[4]], ridge_lollipop, ncol = 3, nrow = 1, rel_widths = c(0.02, 0.25, 0.75))

# Save
ggsave(plot = suppY, filename = "current/doc/figures/R/suppY.pdf", width = 18, height = 12, units = "cm")
