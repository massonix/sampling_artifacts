...
## Load data
We dispose of a demultiplexed, filtered, normalized and annotated Seurat object that contains the transcriptome and metadata of >30,000 Chronic Lymphocytic Leukemia (CLL) cells from two donors (male/female) that were kept at varying times at RT (0h, 2h, 8h, 24h, 48h).
